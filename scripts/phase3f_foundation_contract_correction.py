...
PRIVATE_INPUTS = ROOT / 'workspace/private-inputs/phase3f-foundation'
REC = PRIVATE_INPUTS / 'phase3f_foundation_review_recommendations_295.json'
AUTH = PRIVATE_INPUTS / 'phase3f_foundation_human_review_authorization.json'
REQUEST = PRIVATE_INPUTS / 'task.txt'
